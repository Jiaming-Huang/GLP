%% Simulation Study #7 : known group number & FD-AH
...
% --------------------------- MODEL --------------------------------
% we estimate it using first-differenced model with Anderson-Hsiao IV
% Delta y_it = phi_g* Delta y_it-1 + beta_g* Delta x_it + Delta ep_it
% instrument Delta x_it with z_it
% instrument Delta y_it-1 with y_it-2
% --------------------------- Notes --------------------------------
% The script is basically the same as SIM_KnownG0.m
...
%% SAVE OUTPUT
save_name = strcat('output\SUPP\SIM_FDAH_KnownG',num2str(G0),'_param',num2str(parchoice),...
    '.mat');
save(save_name);
