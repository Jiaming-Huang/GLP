...
B1_hatboot = zeros(VAR.n,VAR.k,nboot,2);
IRF_boot   = zeros(VAR.n,VAR.irhor,nboot,2);
M_count    = zeros(nboot,VAR.k,2);
...
%             end
            ...
            U_boot = detrend(U_boot,'constant');
            ...
            VARBS.proxy = [VAR.proxy(1:VAR.p,:); M_boot];
